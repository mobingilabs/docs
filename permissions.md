...
| <nobr>\|--ModifyRoles</nobr>     | Allowed to modify RBAC roles.                                |                     |
| <nobr>\|--ModifyUserRoles</nobr> | Allowed to modify user-role mappings.                        |                     |
| <nobr>\|----ReadOnly</nobr>      | View RBAC permissions, roles, and mappings.                  |                     |
