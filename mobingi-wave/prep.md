---
description: Preparation for start using Wave.
---

# Preparation

* This page explains thins you need to be done on your AWS account for start using Mobingi Wave.
* After finish preparation, you will need to give Mobingi the below informations. Please keep these info each steps.
...
##  Step 2 :モビンギに読み取り権限を委譲するIAMロールの作成 {#step2}
